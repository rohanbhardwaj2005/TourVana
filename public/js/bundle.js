  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          url = type === "password" ? "https://87772f31-5160-484a-9683-9a8a95fd69ff-00-1w0f1vzamlbqn.riker.replit.dev/api/v1/users/updateMyPassword" : "https://87772f31-5160-484a-9683-9a8a95fd69ff-00-1w0f1vzamlbqn.riker.replit.dev/api/v1/users/updateMe";
          _context.next = 4;
          return (0, _axios.default)({
            method: "PATCH",
            url: url,
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return (0, _axios.default)("https://87772f31-5160-484a-9683-9a8a95fd69ff-00-1w0f1vzamlbqn.riker.replit.dev/api/v1/bookings/checkout-session/".concat(tourId));
        case 3:
